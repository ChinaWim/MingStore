					...
					<c:forEach var="product" items="${productList}">
						<tr onmouseover="this.style.backgroundColor = 'white'"
							...
							<td align="center" style="HEIGHT: 22px"><a
									...
									?pimage=${product.pimage}&pid=${product.pid}&pname=${product.pname}&market_price=${product.market_price}&pdesc=${product.pdesc}&shop_price=${product.shop_price}&is_hot=${product.is_hot}&cid=${product.cid}">
								<img
							...
							<td align="center" style="HEIGHT: 22px">
								<a href="javascript:void(0)"onclick= "isDelete('${product.pid}')" >
...
<script>
    function isDelete(pid) {
			if(confirm("确定要删除该项吗？")){
			    location.href = "${pageContext.request.contextPath}/admin/product?action=delete&pid="+pid;
			}
    }
