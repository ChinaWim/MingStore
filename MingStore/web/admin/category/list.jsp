					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${categories}" var="category">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px">
									<a href="javascript:void(0)" onclick="isDelete('${category.cid}')">
...
<script>
	function isDelete(cid) {
	    if(confirm("确认删除该项吗？"))
		location.href = "${ pageContext.request.contextPath }/admin/category?action=delete&cid="+cid;
    }
