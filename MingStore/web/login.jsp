	...
	<div class="row">
		...
		<div class="col-md-5">
			<div
				...
				<div>&nbsp;</div>
				<form  id="loginForm"  class="form-horizontal" action="${pageContext.request.contextPath}/user?action=login" method="post">
					<div class="form-group">
						...
						<span  id = "error_username" class="error" for="username" style=" color: red">${msg_username}</span>
					</div>
					<div class="form-group">
						...
						<span id = "error_password"  class="error" for="password" style="color: red">${msg_password}</span>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" width="100" value="登录" name="submit" onclick="return validateCode()"
