...
<body>
	...
	<div class="container">
					...
					<tbody>
						...
						<c:forEach var="orderitem" items="${order.orderitems}">
							<tr class="active">
								...
								<td width="30%">
									<a href="${pageContext.request.contextPath}/product?action=productInfo&pid=${orderitem.product.pid}&currentPage=1">
		...
		<div>
			<hr />
			<!--确认支付-->
			<form  action="${pageContext.request.contextPath}/orders" method="post" id="orderForm" class="form-horizontal" style="margin-top: 5px; margin-left: 150px;">
				<!-- post 提交就不要携带参数过去，规范-->
